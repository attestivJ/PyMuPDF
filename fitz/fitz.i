...
dictkey_is_mask = PyUnicode_InternFromString("is_mask");
dictkey_mask = PyUnicode_InternFromString("mask");
...
dictkey_render_mode = PyUnicode_InternFromString("render_mode");
